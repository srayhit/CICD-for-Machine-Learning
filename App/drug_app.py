...
pipe = sio.load(filename, trusted = untrusted_types)

def predict_drugs(age, sex, blood_pressure, cholesterol, na_to_k_ratio):
    '''
        Predict drugs based on patient features

        Args:
            age (int): Age of Patients
            sex (int): Sex of Patients
            blood_pressure (str): Blood pressure level
            cholesterol (str): Cholesterol Level
            na_to_k_ratio (float): Ratio of Sodium and potassium in blood
